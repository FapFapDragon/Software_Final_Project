...
<body>
  ...
  <form>
    <div class="form-group">
      <label for="exampleFormControlInput1">Date And Time Of Shift</label>
      <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="">
    </div>
  
    <div class="form-group">
      <label for="exampleFormControlInput1">Name Of Person Covering Shift (If Applicable)</label>
      <input type="email" class="form-control" id="exampleFormControlInput1" placeholder=""> 
    </div>
    <div class="form-group">
      <label for="exampleFormControlTextarea1">Reason For Shift Change</label>
