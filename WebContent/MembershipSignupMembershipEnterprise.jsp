...
<body>
  ...
  <div class="row">
      ...
      <ul class="list-group mb-3">
        <li class="list-group-item d-flex justify-content-between lh-condensed">
          <div>
            ...
            <small class="text-muted">Enterprise Membership (Billed Monthly)</small>
          </div>
    ...
    <div class="col-md-8 order-md-1">
      <h4 class="mb-3">Singup Information</h4>
      <form class="needs-validation" novalidate="">
        ...
        <hr class="mb-4">
        <a href="SignupSuccess.jsp" class="btn btn-primary btn-lg btn-block" type="submit">Sign up</a>
      </form>
    </div>
  </div>
